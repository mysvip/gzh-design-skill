...
- **7 套精选主题**：摸鱼绿（默认）· 钴蓝信号 · 红白 · 石墨极简 · 留白禅意 · 摸鱼票据 · 橄榄手记 —— 每套都是自成体系的厚组件库（设计变量 + 数十个精细组件 + 视觉层级表 + 文章类型配方表）。
...
其中 6 套主题提供同一篇长文的真实长图；钴蓝信号可在交互式 Gallery 中查看完整 HTML：
...
> 📚 **6 套完整长图 → [docs/all-themes.md](docs/all-themes.md)**　｜　克隆后浏览器打开 `docs/gallery/index.html` 可查看全部 7 套可交互 HTML。
...
| **钴蓝信号** | AI、科技、效率工具、Agent 实践、个人方法论（数字编辑部气质） |
